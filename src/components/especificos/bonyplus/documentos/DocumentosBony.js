...
import intListLargeIcon from '../../../../../resources/imgs/intlistlarge.png';
import cifraoLargeIcon from '../../../../../resources/imgs/cifraolarge.png';
import genericIcon from '../../../../../resources/imgs/checklistlarge.png';
...
class Documentos extends Component {
    ...
    doTouchItem(documentos, title, docNumber) {
        ...
        Actions.documentoBonyApp({ title }); 
    }
                            ...
                            return (
                                <TouchableOpacity
                                    ...
                                    onPress={
                                        () => 
                                        this.doTouchItem(
                                            documento.documents, 'Desconto', '1'
                                        )
                                    }
                                >
                                    <View style={styles.viewRows}>
                                        <Image 
                                            source={intListLargeIcon} 
                            ...
                            return (
                                <TouchableOpacity
                                    ...
                                    onPress={
                                        () => 
                                        this.doTouchItem(
                                            documento.documents, 'Bonificação', '2'
                                        )
                                    }
                                >
                                    <View style={styles.viewRows}>
                                        <Image 
                                            source={cifraoLargeIcon} 
                                            style={styles.ImageStyle} 
                                        />
                                        <View style={styles.secondView}>
                                            <Text style={[styles.textStyle, { flex: 3 }]}>
